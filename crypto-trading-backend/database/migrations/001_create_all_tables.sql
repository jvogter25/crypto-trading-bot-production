...
-- Create positions table for tracking trading positions
...
-- Create market_data table for OHLC and technical indicators
...
-- Create sentiment_data table for raw sentiment data
...
-- Create sentiment_analysis table for processed sentiment signals
...
-- Create performance_metrics table for tracking strategy performance
...
-- Create trading_rules_config table for strategy configuration
...
-- Create grid_trading_state table for grid trading state management
...
-- Create basic policies (allow all operations for now - customize based on your auth requirements)
...
-- Insert default trading rules configuration for stable coin grid strategy
...
-- Create a view for active positions with calculated PnL
...
-- Create a view for grid trading summary
...
-- Create a function to calculate portfolio performance
